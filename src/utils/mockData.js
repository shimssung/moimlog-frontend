...
export const mockMoims = [
  {
    ...
    description: "스크럼과 함께 성장하는 개발자들의 모임입니다. 매주 스크럼 방법론을 학습하고 실제 프로젝트에 적용해보며 함께 성장하는 시간을 가집니다.",
    maxMembers: 20,
    tags: ["개발", "스크럼", "프로젝트"],
    thumbnail: "/img1.jpg"
  },
  {
    ...
    description: "웹과 앱을 아우르는 사이드프로젝트 모임입니다. 아이디어부터 출시까지 함께 만들어가는 과정을 경험해보세요.",
    maxMembers: 15,
    tags: ["웹개발", "앱개발", "프로젝트"],
    thumbnail: "/img2.jpg"
  },
  ...
  },
  {
    ...
    title: "러닝 크루",
    category: CATEGORIES.SPORTS,
    description: "함께 뛰며 건강을 쌓아가는 러닝 모임입니다. 초보자부터 마라톤 준비까지 단계별로 함께 성장합니다.",
    maxMembers: 30,
    tags: ["러닝", "마라톤", "건강"],
    thumbnail: "/img9.jpg"
  },
  {
    ...
    title: "클래식 음악 감상회",
    category: CATEGORIES.OTHER,
    description: "클래식 음악의 아름다움을 함께 나누는 모임입니다. 다양한 작곡가와 곡을 감상하며 음악적 지식을 쌓습니다.",
    maxMembers: 15,
    tags: ["클래식", "음악", "감상"],
    thumbnail: "/img10.jpg"
  },
  {
    ...
    title: "스타트업 네트워킹",
    category: CATEGORIES.BOOK,
    description: "스타트업 창업자와 관심자들이 모여 아이디어를 공유하고 네트워킹하는 모임입니다.",
    maxMembers: 25,
    tags: ["스타트업", "창업", "네트워킹"],
    thumbnail: "/img1.jpg"
  },
  {
    ...
    title: "요가 클래스",
    category: CATEGORIES.SPORTS,
    description: "마음과 몸의 균형을 찾는 요가 모임입니다. 초급부터 고급까지 단계별로 배우며 건강한 라이프스타일을 만듭니다.",
    maxMembers: 20,
    tags: ["요가", "명상", "건강"],
    thumbnail: "/img2.jpg"
  },
  {
    ...
    title: "사진 촬영 모임",
    category: CATEGORIES.OTHER,
    description: "사진 촬영 기술을 배우고 함께 촬영하며 창작 활동을 하는 모임입니다.",
    maxMembers: 18,
    tags: ["사진", "촬영", "창작"],
    thumbnail: "/img3.jpg"
  },
  {
    ...
    title: "와인 테이스팅",
    category: CATEGORIES.OTHER,
    description: "세계 각국의 와인을 맛보고 와인에 대한 지식을 쌓는 모임입니다.",
    maxMembers: 12,
    tags: ["와인", "테이스팅", "문화"],
    thumbnail: "/img4.jpg"
  },
  {
    ...
    title: "보드게임 클럽",
    category: CATEGORIES.GAME,
    description: "다양한 보드게임을 즐기며 새로운 친구들과 즐거운 시간을 보내는 모임입니다.",
    maxMembers: 16,
    tags: ["보드게임", "게임", "친목"],
    thumbnail: "/img5.jpg"
  },
  {
    ...
    title: "프로그래밍 스터디",
    category: CATEGORIES.BOOK,
    description: "프로그래밍 언어를 함께 학습하고 프로젝트를 진행하는 개발자 모임입니다.",
    maxMembers: 22,
    tags: ["프로그래밍", "개발", "스터디"],
    thumbnail: "/img6.jpg"
  },
  ...
  },
  {
    ...
    title: "요리 클래스",
    category: CATEGORIES.OTHER,
    description: "다양한 요리 기법을 배우고 함께 요리하며 즐거운 시간을 보내는 모임입니다.",
    maxMembers: 14,
    tags: ["요리", "쿠킹", "클래스"],
    thumbnail: "/img8.jpg"
  },
  ...
  },
  {
    ...
    title: "테니스 클럽",
    category: CATEGORIES.SPORTS,
    description: "테니스를 배우고 함께 즐기며 건강한 라이프스타일을 만드는 모임입니다.",
    maxMembers: 24,
    tags: ["테니스", "스포츠", "건강"],
    thumbnail: "/img10.jpg"
  }

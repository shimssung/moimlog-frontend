...
const dummyMoim = {
  title: '북클럽: "시크릿 가든"',
  description:
    '우리 북클럽은 고전 및 현대 문학을 함께 읽고 토론하는 모임입니다. 매달 한 권의 책을 선정해 다양한 생각과 감상을 나누며, 새로운 회원도 언제든 환영합니다! 프랜시스 호지슨 버넷의 "시크릿 가든"을 함께 읽고 토론하며, 자연, 치유, 우정이라는 주제로 다양한 생각을 나눠보아요. 모임은 중앙 도서관에서 진행됩니다.',
  image: "/bookclub.jpg",
  category: "북클럽",
  attendees: [
      ...
      <Container>
        ...
        <RightSection>
          ...
          <Section>
            ...
            <SectionText>{dummyMoim.description}</SectionText>
          </Section>
